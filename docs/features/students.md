...
Students are the core users of the school. School admins manage the full student roster, guardians, and profiles. Teachers view students in their classes. Students manage their own profile and guardians. Parents select wards to view attendance, finance, and assignment performance analytics on the **Academics** tab (when enabled).
...
| Action | Result |
|--------|--------|
| On **Family Dashboard**, select a ward from the ward selector. | KPIs and tab content (Attendance, Finance, and Academics when performance analytics is enabled) refresh for the selected child. |
