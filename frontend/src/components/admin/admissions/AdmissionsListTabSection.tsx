...
export const AdmissionsListTabSection: React.FC<AdmissionsListTabProps> = ({handleSearch, admissionsList, selectedFilterStatus, handleFilterStatusChange, refetchAdmissionList, busy}) => {
          ...
          <table className="w-full border-collapse min-w-[500px]">
            ...
            <tbody>
              {(() => {
                      ...
                      <td colSpan={8}>
                        <div className="flex flex-col items-center justify-center py-16 text-center text-gray-500">
                          ...
                          <p className="text-sm text-gray-400 mt-1">
                            Once admissions are added, they will appear in this table.
                          </p>
                        </div>
                      </td>
                    </tr>
                ...
                // Default: render rows
                return admissionsList.map((admission, index) => (
                  <tr key={index}>
