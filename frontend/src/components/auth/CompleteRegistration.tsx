...
const CompleteRegistration: React.FC<ResetPwdProps> = ({token}) => {
  ...
  return (
    <section className="relative px-10 py-12 rounded-3xl border border-white border-solid shadow-sm bg-zinc-100 w-[475px] z-[1] max-md:max-w-[475px] max-md:w-[90%] max-sm:px-5 max-sm:py-8 max-sm:w-[95%]">
      <h1 className="mb-3.5 text-2xl font-bold text-neutral-800">Complete Registration</h1>
      ...
      <div className="relative mt-9 max-sm:mt-6">
        <ActionButton type={ButtonType.submit} text="Complete Registration" loading={isPending} />
      </div>
      </form>
    </section>
  );
